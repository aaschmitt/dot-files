---
name: pdd
description: Guides you through transforming a rough idea into a detailed design document with an implementation plan and todo list, following the Prompt-Driven Development methodology. Systematically refines the idea, conducts research, creates a comprehensive design, and develops an actionable implementation plan. The process is iterative, allowing movement between requirements clarification and research as needed.
...
- You SHOULD inform the user that all project files will be referenced throughout the process and may be brought into context as needed
...
- You MAY use tools like WebSearch, WebFetch, Grep, Glob, or Read to gather information
...
Should I incorporate additional search tools into the research process for broader coverage of template management solutions and industry best practices?
...
Adapted from the [Strands Agents agent-sop](https://github.com/strands-agents/agent-sop/blob/main/agent-sops/pdd.sop.md) (Apache 2.0). Modified for Claude Code skill format and tooling.
